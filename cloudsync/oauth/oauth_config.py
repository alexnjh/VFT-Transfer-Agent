...
class OAuthConfig:
    ...
    def __init__(self, *, app_id: str, app_secret: str,
        ...
        self.ssl_pub_crt = None
        self.ssl_priv_key = None
        ...
        if not self.manual_mode and not self._redirect_server:
            self._redirect_server = OAuthRedirServer(
            html_generator=self._gen_html_response,
            port_range=port_range,
            host_name=host_name,
            ssl_crt=self.ssl_pub_crt,
            ssl_key=self.ssl_priv_key)
