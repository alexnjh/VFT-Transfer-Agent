...
class ApiServer:
    ...
    """
    def __init__(self, addr: str, port: int, crt_path: str, key_path: str, headers=None, log_level=ApiServerLogLevel.ARGS, allow_reuse=False):
        """
        ...
        self.__server.socket = context.wrap_socket(sock=self.__server.socket,server_side=True)
    ...
    def uri(self, path="/", hostname=None):
        ...
        uri = "https://" + hostname + ":" + str(self.port()) + "/" + path
        return uri
